...
\shorterSection{\textbf{Experience}}
  \resumeSubHeadingListStart
    ...
    %   \resumeItem{}
    %     {Built a new weather map overlay feature, providing truck drivers with a real-time wind data display}
    %   \resumeItem{}
    %     {Collaborated with an internal data sourcing team to implement functionality for fetching live wind data and parsed the information for accurate visualization}
    %   \resumeItem{}
...
\shorterSection{\textbf{Skills}}
  ...
  \normalsize
    \item[]{\hspace{-12pt}
     \textbf{Languages}{: C++, C, Python, Bash, Java}
     \hfill
     \textbf{Tools \& Technologies}{: Git, RTOS, Embedded, Boost Libraries, Juce, Vim}
    }
    \vspace{-5pt}
