...
\shorterSection{\textbf{Experience}}
  \resumeSubHeadingListStart
    ...
    {Software Engineer}{Jul 2022 - Present}
      ...
      \resumeItem{}
        {Design and test performant application code for deployment on Yocto embedded platforms}
      \resumeItem{}
      ...
      \resumeItem{}
        {Contribute actively to bi-weekly sprints and play a key role in optimizing Jenkins CI build jobs}
    \resumeItemListEnd
