...
%-----------EXPERIENCE-----------------
\shorterSection{\textbf{Professional Experience}}
  ...
  \resumeItemListStart
    ...
    \resumeItem{}
      {Researched, prototyped, and productionized advanced obfuscation and compilation techniques using LLVM internals and compiler pipelines}
    \resumeItem{}
    ...
    \resumeItem{}
      {Worked extensively with x86\_64 and ARMv8 architectures, ensuring correctness and robustness of low-level transformations across platforms}
    \resumeItem{}
  ...
  %KU Grad Teaching
  \resumeSubheading
  {KU School of Engineering}{Lawrence, USA}
...
\shorterSection{\textbf{Skills}}
  ...
  \textbf{Tools \& Technologies:} LLVM, Embedded Linux, CMake, Boost, CUDA, OpenGL, Git
