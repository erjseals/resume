...
\shorterSection{\textbf{Experience}}
  \resumeSubHeadingListStart
    ...
    {Software Engineer}{Jul 2022 - Present}
      \resumeItemListStart
      \resumeItem{}
        {Developed several new features in C++ for Garmin Dezl and other consumer GPS navigation products}
      \resumeItem{}
        {Created and tested performant application code running on a Yocto embedded platfom}
        \resumeItem{}
        {Responsible for feature development, code review, and weekly release builds}
        \resumeItem{}
        {Collaborated daily with Project Managers, UX Designers, and Software Engineers across different teams}
        \resumeItem{}
        {Participated in bi-weekly sprints and helped optimize Jenkins CI build jobs}
    \resumeItemListEnd
    ...
    {Graduate Teaching Assistant}{Aug 2020 - Dec 2021}
      ...
      % \resumeItem{}
      %   {Designed a final project for the course where students implement a self-driving RC Car}
      %   \begin{itemize}
    ...
    {Software Engineer Intern}{Nov 2020 - May 2021}
      ...
      \resumeItem{}
        {Wrote production code to increase general performance, fix bugs, and polish the GUI on Tread (an Outdoor Adventure Product)}
      \resumeItem{}
...
\shorterSection{\textbf{Projects}}
  \resumeSubHeadingListStart
      ...
      {System-wide memory bandwidth regulation system, \href{https://github.com/erjseals/bandwatch}{github.com/erjseals/bandwatch}
         \vspace{-4pt}
         \begin{itemize}
          \item Implemented a real-time system which reduced memory-contention induced task slowdown from 14.7x to 3.6x
          \vspace{-1pt}
          \item Designed a dynamic regulation algorithm making use of real-time memory utilization statistics
          \vspace{-1pt}
...
\shorterSection{\textbf{Skills}}
  ...
  \normalsize
    \item[]{\hspace{-12pt}
     \textbf{Languages}{: C++, C, Python, Bash, Latex}
     \hfill
     \textbf{Tools \& Technologies}{: Git, RTOS, Embedded, Juce, Boost, MS VS/VC, Vim}
    }
    \vspace{-5pt}
