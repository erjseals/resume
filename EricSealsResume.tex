...
\shorterSection{\textbf{Experience}}
  ...
  \resumeItemListStart
  \resumeItem{}
  {Developed and implemented new features in C++ for Garmin Dezl and other consumer GPS navigation products
  \begin{itemize}
    \item Built a new weather map overlay feature, providing real-time wind data display with OpenGL
    \item Collaborated with an internal data sourcing team to design functionality for fetching live wind data
    \item Subsequently parsed the incoming data and developed efficient visualization software
  \end{itemize}}
  \resumeItem{}
  ...
  \resumeSubHeadingListStart
      ...
      {System-wide memory bandwidth regulation system, \href{https://github.com/erjseals/bandwatch}{github.com/erjseals/bandwatch}
         ...
         \begin{itemize}
          ...
          \vspace{-1pt}
          \item Built as a Linux Kernel module in C targetting the NVIDIA's SoC "Jetson Nano" platform
         \end{itemize}
      }
...
\shorterSection{\textbf{Skills}}
  ...
  \normalsize
    \item[]{\hspace{-12pt}
     ...
     \hfill
     \textbf{Tools \& Technologies}{: Git, RTOS, Embedded, Boost Libraries, OpenGL, Linux, Android, Vim}
    }
    \vspace{-5pt}
